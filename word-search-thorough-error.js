function findWord(str) {
	var array = [];
	var words = ["BL\\-IN\\-KY", "S\\-HINRA", "RAPTURE", "ANIMUS", "FIREFLY", "WALKERS", "TARDIS", "EPONA", "CREEPER", "AVENGER", "PATR\\-ONUS", "WEST\\-EROS", "IFRIT", "ARKHAM", "VAULT", "CLAPTRAP", "NORMANDY", "REAVER", "HEISE\\-NBERG", "STARK", "MORDOR", "BIRDMAN", "TITAN", "OCULUS", "GOOMBA", "KATAMARI"];

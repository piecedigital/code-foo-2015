function findWord(str) {
	var array = [];
	var words = ["BLIN\\-KY", "SH\\-INR\\-A", "RAP\\-T\\-URE", "AN\\-IM\\-US", "FI\\-R\\-EF\\-LY", "WAL\\-KERS", "TARDIS", "EPONA", "CREEP\\-ER", "A\\-V\\-E\\-N\\-GER", "PATRONUS", "WESTEROS", "IFRIT", "ARKHAM", "VAULT", "CLAPTRAP", "NORMANDY", "REAVER", "HEISEN\\-BERG", "STARK", "MORDOR", "BIRDMAN", "TITAN", "OCULUS", "GOOMBA", "KATAMARI"];
	for(i = 0; i < words.length; i++) {
		var regTemp = new RegExp("[" + words[i] + "]", "ig");
		//console.log(regTemp);
		if( str.match(regTemp) ) {
			//console.log(words[i]);
			array.push(words[i]);
		}
	}
